...
func SetupRoutes(app *fiber.App, db *gorm.DB) {
	...
	api.Post("/payment-card/:token/init-harsya", handler.InitHarsyaPaymentSession)
	api.Post("/payment-card/:token/confirm-harsya", handler.ChargeCreditCardHarsya)
	api.Get("/payment/success", handler.PaymentSuccessPage)
	api.Get("/payment/failure", handler.PaymentFailurePage)
	api.Get("/payment/expiration", handler.PaymentExpirationPage)

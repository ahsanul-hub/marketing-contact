...
func (es *EmailService) SendTransactionReport(transactions []model.Transactions, merchantName string, startDate, endDate time.Time) error {
	...
	emailConfig := EmailConfig{
		...
		ToEmails:   strings.Split(config.Config("TO_EMAILS", "zhangshijun@ushareit.com,rinkesh.sharma@payermax.com,fanny@redision.com,juan.rivaldo@ushareit.com,payment_report@payermax.com,huzhihong@payermax.com,huzhihong@ushareit.com,chengjiexin@ushareit.com,aldi@redision.com"), ","),
